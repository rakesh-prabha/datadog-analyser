...
REVENUE BREAKDOWN:
- Revenue Calculation Method: \{{revenueBreakdown}}
- Actual Revenue from Known Orders: $\{{actualRevenue}}
- Estimated Revenue from Unknown Orders: $\{{estimatedMissingRevenue}}
- Data Coverage: \{{actualOrdersWithValues}} of \{{uniqueOrders}} orders have extractable values
...
4. **Revenue Impact Assessment** - Financial implications with breakdown of actual vs estimated revenue, noting the wide price variation in order values
...
Focus on business outcomes and actionable recommendations for management. Pay special attention to the variation in order values when calculating financial impact.`
});
